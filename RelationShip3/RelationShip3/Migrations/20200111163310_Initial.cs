        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CatogryName = table.Column<string>(maxLength: 15, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipAddress = table.Column<string>(maxLength: 40, nullable: true),
                    ShipCiy = table.Column<string>(maxLength: 40, nullable: true),
                    ShipRegion = table.Column<string>(maxLength: 40, nullable: true),
                    ShipPostalCode = table.Column<string>(maxLength: 40, nullable: true),
                    ShipCountry = table.Column<string>(maxLength: 40, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quentity = table.Column<short>(nullable: false),
