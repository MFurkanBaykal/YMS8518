...
namespace RelationShip4.Controllers
{
    ...
    public class CustomerDemographicsController : ControllerBase
    {
        ...
        [HttpPut]
        public IActionResult Update([FromBody]Models.CustomerDemographic customerDemographics)
        {
            _unitOfWork.CustomerDemographicRepository.Update(customerDemographics);
            _unitOfWork.Complete();
            return new JsonResult(customerDemographics);
        }
        [HttpDelete("{id}")]
